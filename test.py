...
n_class   = 9
data_dir  = os.path.abspath('/home/hexunjie/Desktop/SFAF-MA/dataset')
model_dir = os.path.abspath('/home/hexunjie/Desktop/SFAF-MA/weights_existed')
...
def main():
    ...
    test_dataset  = MF_dataset(  data_dir, args.dataset_name,  input_h=args.img_height, input_w=args.img_width)
...
if __name__ == '__main__':
    ...
    if os.path.exists(model_dir) is False:
        ...
        sys.exit()
    model_file = os.path.join(model_dir, 'final.pth')  # change it to have different result
