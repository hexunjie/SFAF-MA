...
class SFAFMA(nn.Module):
    def __init__(self, n_class):
        ...
        resnet_raw_model1 = models.resnet18(pretrained=True) #preweights of backbone
        ...
        self.encoder_downsampling1 = nn.Conv2d(64,64, kernel_size=7, stride=2, padding=3, bias=False)
        self.encoder_downsampling2 = nn.Conv2d(64,128, kernel_size=7, stride=2, padding=3, bias=False)
        self.encoder_downsampling3 = nn.Conv2d(128,256, kernel_size=7, stride=2, padding=3, bias=False)
        self.encoder_downsampling4 = nn.Conv2d(256,512, kernel_size=7, stride=2, padding=3, bias=False)
