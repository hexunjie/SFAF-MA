...
parser.add_argument('--lr_start', '-ls', type=float, default=0.015)
...
if __name__ == '__main__':
    ...
    # preparing folders
    if os.path.exists("/home/hxj/SFAF-MA/runs2"):
        shutil.rmtree("/home/hxj/SFAF-MA/runs2")
    weight_dir = os.path.join("/home/hxj/SFAF-MA/runs2", args.model_name)
    os.makedirs(weight_dir)
    os.chmod(weight_dir, stat.S_IRWXU)  # allow the folder created by docker read, written, and execuated by local machine
 
    writer = SummaryWriter("/home/hxj/SFAF-MA/runs2/tensorboard_log")
    os.chmod("/home/hxj/SFAF-MA/runs2/tensorboard_log", stat.S_IRWXU)  # allow the folder created by docker read, written, and execuated by local machine
    os.chmod("/home/hxj/SFAF-MA/runs2", stat.S_IRWXU)
